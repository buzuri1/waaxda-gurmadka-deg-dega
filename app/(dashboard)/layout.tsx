      ...
      <nav className="h-16 bg-[#CC0000] flex items-center justify-between px-4 md:px-6 sticky top-0 z-50 shrink-0">
        ...
        <div className="flex items-center gap-4 md:gap-5">
          ...
          <div className="relative hidden sm:block" ref={settingsRef}>
            ...
            {settingsOpen && (
              <div className="absolute right-0 top-10 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-[200] overflow-hidden">
                <div className="p-4 border-b border-gray-100 bg-gray-50">
                  <h3 className="font-bold text-sm text-gray-900">Nidaamka Settings</h3>
                  <p className="text-xs text-gray-500 mt-0.5">Maamul nidaamkaaga</p>
                </div>
                <div className="p-2">
                  <a 
                    href="https://wa.me/message/DMQKLSEF4GRJF1" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-start gap-3 w-full p-2 hover:bg-gray-50 rounded-md transition-colors group"
                  >
                    <div className="w-8 h-8 rounded-full bg-[#25D366]/10 flex items-center justify-center shrink-0 group-hover:bg-[#25D366]/20 transition-colors">
                      <svg viewBox="0 0 24 24" width="16" height="16" stroke="none" fill="#25D366">
                    ...
                    <div>
                      <p className="text-sm font-bold text-gray-900 group-hover:text-[#25D366] transition-colors">Contact Developer</p>
                      <p className="text-xs text-gray-500 mt-0.5">Haddii aad aragto wax cilad ah (Error), nagala soo xiriir WhatsApp</p>
                    </div>
                  </a>
                </div>
              </div>
